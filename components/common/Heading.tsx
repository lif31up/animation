...
function Heading({ className, data }: Heading) {
  ...
  return (
    <section className={`${heading.lg} ${heading.xl} ${heading.md} ${heading.sm} ${heading.mb} ${heading.base} ${className}`}>
      <h2 className="text-sm font-bold text-neutral-500 tracking-wider">
        {filename}
      </h2>
